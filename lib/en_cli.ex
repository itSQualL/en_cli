defmodule EnCli do
  ...
  @spec list_devices([owner_id: String.t, page: integer(), page_size: integer()]) :: {:ok, %{}} | {:error, %{message: String.t}}
  defdelegate list_devices(opts \\ []), to: Device, as: :index

  @spec link_device(String.t, String.t) :: {:ok, %{message: String.t}} | {:error, %{errors: %{}}}
